...
# python main.py simple_spread_flip analyze_vf_flipped --seed 3 --n_episodes 2500 --model_save_freq 250 --flip_ep 0 --log_comment "baseline" 
# python main.py simple_spread_flip analyze_vf_flipped_input --seed 3 --n_episodes 4000 --model_save_freq 250 --flip_ep 1500 --log_comment "no_distill_learn" 
# python main.py simple_spread_flip analyze_vf_flipped_input --seed 3 --n_episodes 4000 --model_save_freq 250 --flip_ep 1500 --hard_distill_ep 1500 --log_comment "distill_learn"
# python main.py simple_spread_flip analyze_vf_flipped_input --seed 3 --n_episodes 4000 --model_save_freq 250 --flip_ep 1500 --hard_distill_ep 1500 --skip_actor_length 500 --log_comment "distill_learn_skip_500"
python main.py simple_spread_flip analyze_vf_flipped_input --seed 3 --n_episodes 4000 --model_save_freq 250 --flip_ep 1500 --hard_distill_ep 1500 --hard_distill_only_actor --log_comment "distill_only_actor"
