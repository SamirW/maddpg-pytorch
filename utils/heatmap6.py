...
lndmrk_poses = np.array([[0.75, 0.85], [-0.75, 0.85], [-0.75, -0.1], [-0.75, -0.85], [0.75, -0.85], [0.75, 0.1]])
default_agent_poses = [[0.5, 0.75], [-0.5, 0.75], [-0.5, 0.1], [-0.5, -0.75], [0.5, -0.75], [0.5, -0.1]]
flipped_order = [3,5,2,0,1,4]
flipped_agent_poses = [default_agent_poses[i] for i in flipped_order]
color = {0: 'b', 1: 'g', 2: 'r', 3: [0.35, 0.85, 0.85], 4: [0.85, 0.35, 0.85], 5: [0.85, 0.85, 0.35]}
num_arrows = 21
...
def heatmap6(maddpg, title="Agent Policies", save=False):
    fig, axes = plt.subplots(6, 2)
    plt.subplots_adjust(left=None, bottom=None, right=None, top=None, wspace=None, hspace=0.4)

    fig2, axes2 = plt.subplots(6, 2)
    plt.subplots_adjust(left=None, bottom=None, right=None, top=None, wspace=None, hspace=0.4)

    titles = [["Agent 1, State 1", "Agent 1, State 2"], ["Agent 2, State 1", "Agent 2, State 2"], ["Agent 3, State 1", "Agent 3, State 2"], ["Agent 4, State 1", "Agent 4, State 2"], ["Agent 5, State 1", "Agent 5, State 2"], ["Agent 6, State 1", "Agent 6, State 2"]]
